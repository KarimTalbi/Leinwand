...
class SystemPrompt(Enum):
    PROMPTNODE = (
        "You are an AI assistant embedded in a node-based conversation graph. "
        'Each node with the type "promptNode" represents an independent LLM interaction. '
        "Nodes can be freely connected, meaning context may sometimes appear incomplete, inconsistent, or seemingly unrelated — "
