...
Each node represents an independent LLM interaction. Nodes can be freely connected, \
...
- If a stream begins with a Merge Node, treat its content as the consolidated root context \
